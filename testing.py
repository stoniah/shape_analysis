...
raise ValueError()
original_space = np.load(Path(f'results/linear_shifted_gpa').joinpath('fully_aligned_shapes.npy'))
...
trajectory_orientations = [get_trajectory_orientation_vector(trajectory) for trajectory in shape_space]
